...
export default function NoticiasPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-wrap gap-3 mb-8">
        <div className="relative">
          ...
          <input
            ...
            className="bg-[#111118] border border-white/10 text-white placeholder-gray-500 rounded-xl pl-9 pr-4 py-2.5 text-sm focus:outline-none focus:border-blue-500/50"
          />
        </div>
          ...
          {CATEGORIES.map((c) => (
            <button
              ...
              className={`px-3 py-2 text-sm rounded-xl transition-all ${
                category === c ? "bg-blue-600 text-white" : "bg-[#111118] border border-white/10 text-gray-400 hover:text-white"
              }`}
            >
              {c}
            </button>
      ...
      {/* Featured */}
      {featured && (
        <Link href={`/noticias/${featured.slug}`} className="group block bg-[#111118] border border-white/5 rounded-3xl overflow-hidden mb-10 hover:border-blue-500/20 transition-all">
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 flex flex-col justify-center">
              <span className="text-xs text-blue-400 bg-blue-900/30 px-2 py-1 rounded-full mb-3 inline-block w-fit">
                {featured.category}
              </span>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
        {rest.map((article) => (
          <Link
            ...
            className="group bg-[#111118] border border-white/5 rounded-2xl overflow-hidden hover:border-blue-500/20 transition-all"
          >
            <div className="relative h-48 overflow-hidden">
              ...
              <div className="absolute top-3 left-3">
                <span className="text-xs text-white bg-blue-600 px-2 py-1 rounded-full">{article.category}</span>
              </div>
            </div>
            <div className="p-5">
